...
class TutorProfileRequest extends FormRequest
{
    ...
    {
        return [
            'hourly_rate' => 'required|numeric|min:0.01|max:10000000', // Supports both USD (up to $10,000) and VND (up to 10,000,000)
    ...
    public function messages(): array
    {
        return [
            ...
            'hourly_rate.max' => __('Hourly rate cannot exceed 10,000,000'),
